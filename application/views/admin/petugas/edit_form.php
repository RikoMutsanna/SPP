				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php base_url('admin/petugas/add') ?>" method="post" enctype="multipart/form-data" >
							 ...
							 <input type="hidden" name="id" value="<?php echo $product->id_petugas?>" />
						...
						<div class="form-group">
								...
								<input class="form-control <?php echo form_error('username') ? 'is-invalid':'' ?>"
								 type="text" name="username"  value="<?php echo $product->username?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama_petugas') ? 'is-invalid':'' ?>"
								 type="text" name="nama_petugas"  value="<?php echo $product->nama_petugas?>" />
								<div class="invalid-feedback">
