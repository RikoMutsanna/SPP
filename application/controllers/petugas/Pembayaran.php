...
class Pembayaran extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("petugas/pembayaran/list", $data);
    }
    ...
    public function add()
    {
        ...
        $this->load->view("petugas/pembayaran/new_form", $data);
    }

    public function edit($id)
    {
        if (!isset($id)) redirect('petugas/pembayaran');
        ...
        $data['siswa'] = $this->select_model->siswa();
        $data['spp'] = $this->select_model->spp();
        $this->load->view("petugas/pembayaran/edit_form", $data);
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->pembayaran_model->delete($id)) {
            redirect(site_url('petugas/pembayaran'));
        }
    }
}